<?php
namespace common\modules\wishlist\widgets;
...
class WishlistButton extends \yii\base\Widget
{
    ...
    public function init()
    {
        ...
        \common\modules\wishlist\assets\WidgetAsset::register($this->getView());
    ...
    public function run()
    {
        ...
        $action = $elementModel == null ? 'add' : $elementModel->action;
